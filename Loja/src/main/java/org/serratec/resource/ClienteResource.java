...
public class ClienteResource {
	...
	public ResponseEntity<?> getClientesPorNome(@PathVariable String usuario) throws ClienteException{
    	...
    	Cliente cliente = clienteRepository.findByUsuario(usuario)
    			.orElseThrow(() -> new ClienteException("Cliente nao logado."));
	...
	public ResponseEntity<?> update(@PathVariable String usuario, @RequestBody ClienteCadastroDTO dto ) throws ClienteException{
		
		Cliente cliente = clienteRepository.findByUsuario(usuario).orElseThrow(() -> new ClienteException ("Cliente não encontrado"));
