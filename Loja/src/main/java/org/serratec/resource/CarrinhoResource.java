...
public class CarrinhoResource {
	...
	public ResponseEntity<?> postCarrinho(@RequestBody CartCadastroDTO dto) throws ProdutoException, ClienteException, CarrinhoException {
	    ...
	    Carrinho carrinho = dto.toCarrinho(produtoRepository, clienteRepository, carrinhoProdutoRepository);
	...
	@DeleteMapping("/pedido-finalizado/{id}")
	public ResponseEntity<?> deletePedido(@PathVariable Long id) throws PedidoException{
		
		Carrinho carrinho = carrinhoRepository.findById(id).orElseThrow(() -> new PedidoException("Pedido não encontrado!"));
