...
public class CategoriaResource {
	...
	@ApiOperation(value = "Pesquisa de categorias por id.")
	@GetMapping("/categoria/{id}")
	public ResponseEntity<?> findCategoriaById(@PathVariable Long id) throws ProdutoException, CategoriaException{
