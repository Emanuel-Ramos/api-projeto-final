...
public class CarrinhoProdutoCadastroDTO {
	...
	public CarrinhoProduto toCarrinhoProduto(ProdutoRepository produtoRepository, CarrinhoProdutoRepository carrinhoProdutoRepository) throws ProdutoException {
		...
		produtoPedido.setPreco(produto.getPreco() * quantidade);
